...
public class MonsterFox extends Monster {
	// Images!
	...
	public MonsterFox(int xPos, int yPos, int LBound, int RBound) throws Exception {
		...
		try {
			...
			if (walkingImages == null) {
				...
				frozen = ImageIO.read(new File("foxFrozen.png"));
				hit = ImageIO.read(new File("foxHit.png"));
				poisonedHit = ImageIO.read(new File("foxPoisonedHit.png"));
				frozenHit = ImageIO.read(new File("foxFrozenHit.png"));
				
				walking1 = ImageIO.read(new File("foxwalk1.png"));
				walking2 = ImageIO.read(new File("foxwalk2.png"));
				walking3 = ImageIO.read(new File("foxwalk3.png"));
				walking4 = ImageIO.read(new File("foxwalk4.png"));
				walking5 = ImageIO.read(new File("foxwalk5.png"));
				walking6 = ImageIO.read(new File("foxwalk6.png"));
				walking7 = ImageIO.read(new File("foxwalk7.png"));
				walking8 = ImageIO.read(new File("foxwalk8.png"));
				walking9 = ImageIO.read(new File("foxwalk9.png"));
				walking10 = ImageIO.read(new File("foxwalk10.png"));
				walking11 = ImageIO.read(new File("foxwalk11.png"));
				walking12 = ImageIO.read(new File("foxwalk12.png"));
				
				poisoned1 = ImageIO.read(new File("foxpoisoned1.png"));
				poisoned2 = ImageIO.read(new File("foxpoisoned2.png"));
				poisoned3 = ImageIO.read(new File("foxpoisoned3.png"));
				poisoned4 = ImageIO.read(new File("foxpoisoned4.png"));
				poisoned5 = ImageIO.read(new File("foxpoisoned5.png"));
				poisoned6 = ImageIO.read(new File("foxpoisoned6.png"));
				poisoned7 = ImageIO.read(new File("foxpoisoned7.png"));
				poisoned8 = ImageIO.read(new File("foxpoisoned8.png"));
				poisoned9 = ImageIO.read(new File("foxpoisoned9.png"));
				poisoned10 = ImageIO.read(new File("foxpoisoned10.png"));
				poisoned11 = ImageIO.read(new File("foxpoisoned11.png"));
				poisoned12 = ImageIO.read(new File("foxpoisoned12.png"));
